...
var HeatmapImageryProvider = function(options) {
    ...
    this._heatmap = h337.create(this._options); // eslint-disable-line jsx-control-statements/jsx-jcs-no-undef
...
defineProperties(HeatmapImageryProvider.prototype, {
    ...
    // readyPromise: {
    //     get: function() {
    //         console.log('readyPromise:', this._ready);
...
module.exports = HeatmapImageryProvider;
